...
test('div', () => {
  expect(new PrecisionNumber('12', 0).divideByPositiveInteger(5)).toEqual(new PrecisionNumber('2', 0))
  expect(new PrecisionNumber('8312', -2, 2).divideByPositiveInteger(17)).toEqual(new PrecisionNumber('489', -2, 1))
  expect(new PrecisionNumber('0', -3).divideByPositiveInteger(4)).toEqual(new PrecisionNumber('0', -3))
  expect(new PrecisionNumber('12', 0).divideByPositiveInteger(5)).toEqual(new PrecisionNumber('2', 0))
  expect(new PrecisionNumber('02', 0, 1).divideByPositiveInteger(5)).toEqual(new PrecisionNumber('0', 0))
  expect(new PrecisionNumber('06', 0, 1).divideByPositiveInteger(2)).toEqual(new PrecisionNumber('0', 0))
  expect(new PrecisionNumber('0', 0).divideByPositiveInteger(3423)).toEqual(new PrecisionNumber('0', 0))
  expect(new PrecisionNumber('0000984713', 3, 4).divideByPositiveInteger(3423)).toEqual(new PrecisionNumber('0', 0))
  expect(new PrecisionNumber('984713', 0, 1).divideByPositiveInteger(345235)).toEqual(new PrecisionNumber('0', 0))
  expect(new PrecisionNumber('984713', 0, 1).divideByPositiveInteger(3)).toEqual(new PrecisionNumber('328238', 0, 1))
  expect(() => new PrecisionNumber('1', 0).divideByPositiveInteger(0)).toThrow(RangeError)
  expect(() => new PrecisionNumber('1', 0).divideByPositiveInteger(-1)).toThrow(RangeError)
  expect(() => new PrecisionNumber('1', 0).divideByPositiveInteger(1.34)).toThrow(RangeError)
  expect(() => new PrecisionNumber('1', 0).divideByPositiveInteger(-0.0002)).toThrow(RangeError)
})
